; $ID:	HUEANGLE-LEE.PRO,	2023-03-13-13,	USER-KJWH	$
  PRO HUEANGLE-LEE
...
;
; CALLING SEQUENCE:
;   HUEANGLE-LEE,$Parameter1$, $Parameter2$, $Keyword=Keyword$, ....
;
; REQUIRED INPUTS:
...
;   Mar 13, 2023 - KJWH: Initial code written
;-
; ****************************************************************************************************
  ROUTINE_NAME = 'HUEANGLE-LEE'
  COMPILE_OPT IDL2
  SL = PATH_SEP()


END ; ***************** End of HUEANGLE-LEE *****************
